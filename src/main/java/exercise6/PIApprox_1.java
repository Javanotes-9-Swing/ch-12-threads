...
public class PIApprox_1 extends JPanel {
    ...
    private JLabel countLabel;       // The number of times positions have been
...
//    synchronized void trialGenerator(long trialCount, long inCircleCount) {
//
//        for (int i = 0; i < BATCH_SIZE; i++) {
//            double x = Math.random();
//            double y = Math.random();
