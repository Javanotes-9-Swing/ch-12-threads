...
public class MostDivisorsThreadPool {
	...
	public static void main(String[] args) {
		...
		MostDivisorsThreadPool mostDivsClass = new MostDivisorsThreadPool();
	...
	private void incrementWithThreads(int numberOfThreads, int range) {
		...
		CountDivisorsThread[] worker = new MostDivisorsThreadPool.CountDivisorsThread[numberOfThreads];
		for (int i = 0; i < numberOfThreads; i++) {
			worker[i] = new MostDivisorsThreadPool.CountDivisorsThread((increment * i) + 1, increment * (i + 1) );
		}
