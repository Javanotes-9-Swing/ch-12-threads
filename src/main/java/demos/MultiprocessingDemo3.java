...
public class MultiprocessingDemo3 extends JPanel {
	...
	/**
	 * The thread pool.  Note:  The threads are created in
	...
	/** The queue that holds individual tasks;*/
	private LinkedBlockingQueue<Runnable> taskQueue;

	/** Job number of the current computation job.
	...
	private volatile int jobNumber;

	/** The number of tasks that make up one computation job.*/
	private int taskCount;

	/**
	 * How many tasks in the current job have finished?
	 */
	...
	/**
	 * olds a spectrum of RGB color values; used in computing pixel colors.
	 */
	int[] palette;
