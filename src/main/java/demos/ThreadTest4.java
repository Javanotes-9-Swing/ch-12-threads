...
public class ThreadTest4 {
    ...
    /**
     <p>Counts the primes in the range from (START+1) to (2*START), using an ExecutorService
     ...
     * The tasks are submitted to an ExecutorService for execution.</p>
     <p>
     ...
     * get() will block until the computation has been completed.</p>
     */
