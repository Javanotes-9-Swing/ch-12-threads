...
public class MostDivisorsStream {
    ...
    static void main() {
        ...
        System.out.println("Choose a number and the number between 1 and your number with the most divisors will be found.");
    ...
    private static void countDivisorsWithStream(int numberOfTasks, int theNumber) {
        ...
        ArrayList<MostDivisors> mostDivisors = new ArrayList<>();
